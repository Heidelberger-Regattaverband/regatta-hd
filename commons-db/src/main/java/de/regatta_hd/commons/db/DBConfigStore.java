...
/**
 * A service to store {@link DBConfig database configuration} of last successful login.
 */
public interface DBConfigStore {

	/**
	 * @return the {@link DBConfig database configuration} of last successful login or <code>null</code> if not
	 *         available
	 ...
	 *
	 * @param connectionData the {@link DBConfig database configuration} to store
